...
layui.define(['table', 'form', 'laydate', 'util', 'excel', 'laytpl'], function (exports) {
  ...
  var mod = {
    ...
    render: function (myTable) {
      ...
      $('#soul-filter-sample-btn').on('click', function (e) {
    ...
    , bindFilterClick: function (myTable) {
      ...
      function showFilter($that) {
        ...
        // input同步筛选条件
        $('#soul-filter-sample-search').on('input', function () {
          updateFieldWhere(field, $(this).val())
        });
        $('#soul-filter-clear-btn').on('click', function (e) {
      ...
      $('#soul-filter-sample' + tableId).on('click', function (e) {
